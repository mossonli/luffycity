    ...
    <div class="g-banner pr" @mouseleave="state.current_menu = -1">
        ...
        <div class="recomment clearfix">
          ...
          >
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text"
                    >前端框架及项目面试 聚焦Vue3/React/Webpack</span
                  >
          ...
          <a href="" target="_blank" title="" class="recomment-item">
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text">Vue.js 从入门到精通</span>
        ...
        <div class="recomment clearfix">
          ...
          >
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text">Python工程师（全能型）</span>
                  <span class="tag tixi">体系</span>
                </p>
              </div>
              <div class="bottom">
          ...
          <a href="" target="_blank" title="" class="recomment-item">
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text">SpringBoot从入门到精通</span>
                  <span class="tag lujing">路线</span>
                </p>
              </div>
              <div class="bottom">
        ...
        <div class="recomment clearfix">
          ...
          >
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text">移动端架构师成长体系课</span>
                  <span class="tag tixi">体系</span>
                </p>
              </div>
              <div class="bottom">
          ...
          <a href="" target="_blank" title="" class="recomment-item">
            ...
            <div class="details">
              ...
              <div class="title-box">
                <p class="title">
                  <span class="text">Android工程师高薪面试突破路线</span>
                  <span class="tag lujing">路线</span>
                </p>
              </div>
              <div class="bottom">
      ...
      <div class="g-banner-content" @mouseover="state.current_menu = -1">
        <el-carousel :interval="5000" arrow="always" height="482px">
          <el-carousel-item>
            <img
              src="http://fuguangapi.oss-cn-beijing.aliyuncs.com/1.jpg"
              alt=""
          ...
          <el-carousel-item>
            <img
              src="http://fuguangapi.oss-cn-beijing.aliyuncs.com/2.jpg"
              alt=""
              style="width: 100%; height: 100%"
            />
          </el-carousel-item>
          <el-carousel-item>
            <img
              src="http://fuguangapi.oss-cn-beijing.aliyuncs.com/3.jpg"
              alt=""
              style="width: 100%; height: 100%"
            />
          </el-carousel-item>
          <el-carousel-item>
            <img
              src="http://fuguangapi.oss-cn-beijing.aliyuncs.com/4.jpg"
              alt=""
              style="width: 100%; height: 100%"
            />
          </el-carousel-item>
          <el-carousel-item>
            <img
              src="http://fuguangapi.oss-cn-beijing.aliyuncs.com/5.jpg"
              alt=""
              style="width: 100%; height: 100%"
            />
          </el-carousel-item>
