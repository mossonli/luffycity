    ...
    <div class="main">
      ...
      <div class="course-tab">
        <ul class="tab-list">
          ...
          <li :class="state.tabIndex === 2 ? 'active' : ''" @click="state.tabIndex = 2">
            课程章节
            <span :class="state.tabIndex !== 2 ? 'free' : ''">(试学)</span>
          </li>
      ...
      <div class="course-content">
        <div class="course-tab-list">
          ...
          <div class="tab-item" v-if="state.tabIndex === 3">用户评论</div>
          <div class="tab-item" v-if="state.tabIndex === 4">常见问题</div>
        </div>
