        ...
        <div class="actual-header-wrap">
          ...
          <div class="actual-header-search">
            ...
            <div class="search-hot">
              <span>热搜：</span>
              <a href="" @click.stop.prevent="search_by_hotword(hot_word)" v-for="hot_word in course.hot_word_list" v-bind:key="hot_word">{{ hot_word }}</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="type-wrap">
          <div class="one warp">
            ...
            <ul class="items">
              ...
              <li
                :class="{ cur: course.current_direction === direction.id }"
          ...
          <div class="two warp">
            ...
            <ul class="items">
              ...
              <li :class="{ cur: course.current_category === category.id }" v-for="category in course.category_list" v-bind:key="category">
...
.actual-header .actual-header-wrap .actual-header-search .search-inner .actual-search-button {
  ...
  line-height: 26px;
  color: #fff;
  background-color: rgba(84, 92, 99, 0.2);
  cursor: pointer;
